...
image, handleClick}) => {
    ...
    cursor-pointer' onClick={handleClick}>
        <img src={image} alt='fund' className='w-full h-[158px] rounded-[15px] object-cover '/>
        ...
        <div className="flex flex-col p-4">
            ...
            <div className="block">
                ...
                truncate'>{title}</h3> {/*Truncate shrinks the text if it exceeds the given size */}
                <p className='mt-[15px] font-epilogue font-normal
                text-[#808191] text-left leading-[18px] truncate'> {description} </p>
            </div>
            ...
            <div className="flex flex-wrap justify-between mt-[15px] gap-2">
                <div className="flex flex-col">
                    ...
                    <p className='mt-[3px] font-epilogue font-normal leading-[18px] text-[12px] text-[#808191]
